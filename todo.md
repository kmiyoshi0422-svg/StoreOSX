...
- [ ] 既存公開ドメインへ再公開し、配信中の案件詳細に対象文言が含まれることを確認
...
- [ ] Drizzleのstore_master定義・storeMaster.list実装・マイグレーションを照合
- [ ] 実DBを読み取り専用SQLで確認し、不足列・型差異を特定
- [ ] 非破壊の修正SQL・ロールバック・適用順序を作成
- [ ] APIと案件詳細画面の再検証手順を整理して報告
